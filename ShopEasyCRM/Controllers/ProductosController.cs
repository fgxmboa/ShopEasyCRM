...
namespace ShopEasyCRM.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(ShopEasyContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,CodigoBarras,Nombre,Descripcion,Precio,Categoria,Stock,Estado")] Producto producto)
        {
